...
class MainMenu(ttk.Frame):
	def __init__(self, root):
		super().__init__(root)
		self.battle_button = ttk.Button(self, text="Battle", command=root.switch_battle)
		...
		self.pokedex_button = ttk.Button(self, text="Pokedex", command=root.switch_pokedex)
		self.pokedex_button.grid(row=2, column=0, padx=5, pady=5, ipadx=50, ipady=10)

		self.exit_button = ttk.Button(self, text="Exit", command=root.destroy)
